...
<div class="container">
    <div class="row">
        <div class="col-lg-offset-2 col-sm-3 text-center home-box1">
            <h2 class="deep-purple">خدمة لدينا <br /> الزبائن جيدا</h2>
            <p class="box-desc">
                الزبائن هي شريان الحياة ل أعمالنا. معرفة بعض الطرق اننا وضع العملاء في قلب كل ما نقوم به .
            </p>
        ...
        <div class="col-lg-offset-2 col-sm-4 text-center home-box2">
            <h2 class="deep-purple">مسؤولية الشركات<br /> تقرير 2013</h2>
            <p class="box-desc-2">
                <br />
                قرأت عن استراتيجيتنا مسؤولية الشركات لمدة خمس سنوات <br /> 
                <strong>"مما يجعل الأمور أفضل معا"</strong> 
            </p>
